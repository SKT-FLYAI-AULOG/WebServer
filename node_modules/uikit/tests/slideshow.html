                        ...
                        <li>
                            ...
                            <div class="uk-position-center uk-position-medium uk-text-center">
                                <div uk-slideshow-parallax="scale: 1,1,0.8">
                                    <h1 class="uk-heading-medium" uk-slideshow-parallax="x: 200,0,0">Heading</h1>
            ...
            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1">
                ...
                <ul class="uk-slideshow-items">
                    <li>
                        <img src="images/photo.jpg" alt="" uk-cover>
                        <div class="uk-position-center uk-position-medium uk-text-center">
                            <h1 class="uk-heading-medium" uk-slideshow-parallax="x: 200,-200">Heading</h1>
                    ...
                    <li>
                        <img src="images/light.jpg" alt="" uk-cover>
                        <div class="uk-position-center uk-position-medium uk-text-center">
                            <h1 class="uk-heading-medium" uk-slideshow-parallax="y: -100,0,0; opacity: 1,1,0">Heading</h1>
            ...
            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1">
                ...
                <ul class="uk-slideshow-items" uk-height-viewport="min-height: 300">
                    <li>
                        <img src="images/photo.jpg" alt="" uk-cover>
                        <div class="uk-position-center uk-position-medium uk-text-center">
                            <h1 class="uk-heading-xlarge" uk-slideshow-parallax="x: 200,-200">Heading</h1>
                    ...
                    <li>
                        <img src="images/light.jpg" alt="" uk-cover>
                        <div class="uk-position-center uk-position-medium uk-text-center">
                            <h1 class="uk-heading-xlarge" uk-slideshow-parallax="y: -100,0,0; opacity: 1,1,0">Heading</h1>
