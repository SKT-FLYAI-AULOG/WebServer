...
<html lang="en-gb" dir="ltr">
    ...
    <body>
        ...
        <div class="uk-container">
            ...
            <div class="uk-margin">
                <select id="js-center-switcher" class="uk-select uk-form-width-small">
                ...
                <select id="js-sets-switcher" class="uk-select uk-form-width-small">
        ...
        <div class="uk-margin" uk-slider>
            ...
            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1">
                ...
                <ul class="uk-slider-items uk-grid-large uk-grid-match uk-grid" uk-height-viewport="min-height: 200">
