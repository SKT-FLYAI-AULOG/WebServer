    ...
    <body>
                ...
                <table class="uk-table uk-table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Boolean</td>
                            <td>true</td>
                            <td>Define a target container via a selector to specify where the modal should be appended in the DOM.</td>
                        </tr>
                        <tr>
        ...
        <div id="modal-stack-1" uk-modal>
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-footer uk-text-right">
                    <button class="uk-button uk-button-default uk-modal-close" type="button">Cancel</button>
                    <a href="#modal-stack-2" class="uk-button uk-button-primary" uk-toggle>Next</a>
                </div>
            </div>
        </div>

        <div id="modal-stack-2" uk-modal="stack: true">
            <div class="uk-modal-dialog">
                <button class="uk-modal-close-default" type="button" uk-close></button>
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Headline 2</h2>
