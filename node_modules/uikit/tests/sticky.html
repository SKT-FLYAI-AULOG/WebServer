...
<html lang="en-gb" dir="ltr">
    ...
    <body>
        ...
        <!-- position relative is needed because of the test toolbar -->
        <!-- position relative and z-index are needed for sticky cover and reveal sections -->
        <div class="uk-container uk-position-relative uk-position-z-index-zero">
                ...
                <table class="uk-table uk-table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>String</td>
                            <td>false</td>
                            <td>The animation to use.</td>
                        </tr>
                        <tr>
                            <td><code>cls-active</code></td>
                            <td>String</td>
                            <td>uk-active</td>
                            <td>The active class.</td>
                        </tr>
                        <tr>
                            <td><code>cls-inactive</code></td>
                            <td>String</td>
                            <td>''</td>
                            <td>The inactive class.</td>
                        </tr>
                        <tr>
                            <td><code>sel-target</code></td>
                            <td>CSS Selector</td>
                            <td>self</td>
                        ...
                        <tr>
                            ...
                            <td>Boolean</td>
                            <td>false</td>
                            <td>Only show sticky element when scrolling up.</td>
                        </tr>
                        <tr>
